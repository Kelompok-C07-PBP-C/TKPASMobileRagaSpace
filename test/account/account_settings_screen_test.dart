...
void main() {
  ...
  testWidgets('AccountSettingsScreen loads account and saves profile successfully', (
    tester,
  ) async {
    ...
    await tester.pumpWidget(
      MaterialApp(home: AccountSettingsScreen(picker: _FakePicker())),
    );
    ...
    final dynamic state = tester.state(find.byType(AccountSettingsScreen));
  ...
  testWidgets('AccountSettingsScreen shows login error when user id missing', (
    tester,
  ) async {
    accountUserIdOverride = () => null;
