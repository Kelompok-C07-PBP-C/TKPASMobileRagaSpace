...
urlpatterns = [
    ...
    path('venues/<int:venue_id>/availability/', views.venue_availability_view, name='api-venue-availability'),
    ...
    path('venues/<int:venue_id>/reviews/<int:review_id>/', views.venue_review_detail_view, name='api-venue-review-detail'),
